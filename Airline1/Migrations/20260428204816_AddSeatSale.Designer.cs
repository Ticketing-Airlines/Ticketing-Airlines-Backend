...
namespace Airline1.Migrations
{
    ...
    [Migration("20260428204816_AddSeatSale")]
    partial class AddSeatSale
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Airline1.Models.Airline", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Airline1.Models.BoardingPass", b =>
                {
                    b.Property<Guid>("BoardingPassId")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Airline1.Models.CheckIn", b =>
                {
                    b.Property<Guid>("CheckInId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("CreatedAt")
                        .HasDatabaseName("IX_CheckIn_CreatedAt");
            ...
            modelBuilder.Entity("Airline1.Models.DeviceLocation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Airline1.Models.PaymentFAQ", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("DisplayOrder")
                        .HasDatabaseName("IX_PaymentFAQ_DisplayOrder");

                    b.HasIndex("IsActive")
                        .HasDatabaseName("IX_PaymentFAQ_IsActive");

                    b.ToTable("PaymentFAQs");
                });

            modelBuilder.Entity("Airline1.Models.PaymentMethod", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
                    ...
                    b.Property<string>("FeeDisplayText")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");

                    b.Property<decimal?>("FeeFixedAmount")
                        .HasPrecision(10, 2)
                        .HasColumnType("decimal(10, 2)");
                    ...
                    b.HasIndex("Category")
                        .HasDatabaseName("IX_PaymentMethod_Category");

                    b.HasIndex("DisplayOrder")
                        .HasDatabaseName("IX_PaymentMethod_DisplayOrder");

                    b.HasIndex("Featured")
                        .HasDatabaseName("IX_PaymentMethod_Featured");

                    b.HasIndex("IsActive")
                        .HasDatabaseName("IX_PaymentMethod_IsActive");
            ...
            modelBuilder.Entity("Airline1.Models.SeatSale", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");

                    b.Property<DateOnly>("BookingDeadline")
                        .HasColumnType("date");
                    ...
                    b.Property<DateOnly>("TravelPeriodEnd")
                        .HasColumnType("date");

                    b.Property<DateOnly>("TravelPeriodStart")
                        .HasColumnType("date");
            ...
            modelBuilder.Entity("Airline1.Models.SeatSaleConfig", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("SaleSubtitle")
                        .IsRequired()
                        .HasMaxLength(255)
                        .HasColumnType("nvarchar(255)");
                    ...
                    b.ToTable("SeatSaleConfigs");
                });

            modelBuilder.Entity("Airline1.Models.TermsCondition", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("SeatSaleConfigId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("SeatSaleConfigId");

                    b.ToTable("TermsConditions");
                });

            modelBuilder.Entity("Airline1.Models.TrackingDevice", b =>
                {
                    b.Property<string>("DeviceId")
                        .HasMaxLength(450)
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Airline1.Models.BoardingPass", b =>
                {
                    b.HasOne("Airline1.Models.CheckIn", "CheckIn")
                        .WithOne("BoardingPass")
                        .HasForeignKey("Airline1.Models.BoardingPass", "CheckInId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Airline1.Models.DeviceLocation", b =>
                {
                    b.HasOne("Airline1.Models.TrackingDevice", "Device")
                        .WithMany()
            ...
            modelBuilder.Entity("Airline1.Models.Flight", b =>
                {
                    ...
                    b.HasOne("Airline1.Models.Airline", "Airline")
                        .WithMany()
            ...
            modelBuilder.Entity("Airline1.Models.TermsCondition", b =>
                {
                    b.HasOne("Airline1.Models.SeatSaleConfig", "SeatSaleConfig")
                        .WithMany("TermsAndConditions")
                        .HasForeignKey("SeatSaleConfigId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("SeatSaleConfig");
                });
