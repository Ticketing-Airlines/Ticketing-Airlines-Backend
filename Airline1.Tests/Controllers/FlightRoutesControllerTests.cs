...
namespace Airline1.Tests.Controllers
{
    public class FlightRoutesControllerTests
    {
        ...
        {
            var request = new CreateFlightRouteRequest { Code = "FR1", OriginAirportId = 1, DestinationAirportId = 2 };
            var response = new FlightRouteResponse { Id = 1, Code = "FR1", OriginAirportId = 1, OriginAirportName = "Origin", DestinationAirportId = 2, DestinationAirportName = "Dest", FrequencyWeekly = 7, IsActive = true };
        ...
        public async Task GetAll_ReturnsOkResult_WithListOfFlightRoutes()
        {
            var routes = new List<FlightRouteResponse> {
                new FlightRouteResponse { Id = 1, Code = "FR1", OriginAirportId = 1, OriginAirportName = "Origin1", DestinationAirportId = 2, DestinationAirportName = "Dest1", FrequencyWeekly = 7, IsActive = true },
                new FlightRouteResponse { Id = 2, Code = "FR2", OriginAirportId = 3, OriginAirportName = "Origin2", DestinationAirportId = 4, DestinationAirportName = "Dest2", FrequencyWeekly = 3, IsActive = true }
            };
        ...
        {
            var route = new FlightRouteResponse { Id = 1, Code = "FR1", OriginAirportId = 1, OriginAirportName = "Origin", DestinationAirportId = 2, DestinationAirportName = "Dest", FrequencyWeekly = 7, IsActive = true };
        ...
        {
            var request = new UpdateFlightRouteRequest { Code = "FR1", FrequencyWeekly = 5 };
            var updated = new FlightRouteResponse { Id = 1, Code = "FR1", OriginAirportId = 1, OriginAirportName = "Origin", DestinationAirportId = 2, DestinationAirportName = "Dest", FrequencyWeekly = 5, IsActive = true };
        ...
        {
            var request = new UpdateFlightRouteRequest { Code = "FR99", FrequencyWeekly = 1 };
