...
namespace Airline1.Tests.Controllers
{
    public class PassengersControllerTests
    {
        ...
        {
            var list = new List<PassengerResponse> { new PassengerResponse { Id = "1" } };
        ...
        {
            var req = new CreatePassengerRequest { FirstName = "A", LastName = "B", DateOfBirth = DateTime.Now };
            var created = new PassengerResponse { Id = "2" };
